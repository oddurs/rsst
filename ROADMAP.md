...
- [x] [`0066`](https://github.com/oddurs/rsst/blob/main/cairn/items/0066-be-polite-to-one-host-not-just-to-the-network.md) Be polite to one host, not just to the network <sup>feature · v1.5 · p2</sup>
...
- [ ] [`0097`](https://github.com/oddurs/rsst/blob/main/cairn/items/0097-the-key-reference-no-longer-fits-a-forty-row-terminal.md) The key reference no longer fits a forty-row terminal <sup>bug · v1.7 · p2</sup>
...
- [x] [`0080`](https://github.com/oddurs/rsst/blob/main/cairn/items/0080-sorting-is-one-boolean-where-it-should-be-a-choice.md) Sorting is one boolean where it should be a choice <sup>feature · v1.7 · p1</sup>
...
- [ ] [`0084`](https://github.com/oddurs/rsst/blob/main/cairn/items/0084-a-filter-query-for-the-entry-list.md) A filter query for the entry list <sup>feature · v1.8 · p1</sup>
- [ ] [`0085`](https://github.com/oddurs/rsst/blob/main/cairn/items/0085-saved-searches-that-behave-like-folders.md) Saved searches that behave like folders <sup>feature · v1.8 · p2</sup>
- [ ] [`0086`](https://github.com/oddurs/rsst/blob/main/cairn/items/0086-rules-that-act-on-entries-as-they-arrive.md) Rules that act on entries as they arrive <sup>feature · v1.8 · p1</sup>
- [ ] [`0087`](https://github.com/oddurs/rsst/blob/main/cairn/items/0087-tag-an-entry-not-just-a-feed.md) Tag an entry, not just a feed <sup>feature · v1.8 · p2</sup>
- [ ] [`0088`](https://github.com/oddurs/rsst/blob/main/cairn/items/0088-a-read-later-queue.md) A read-later queue <sup>feature · v1.8 · p2</sup>
- [ ] [`0089`](https://github.com/oddurs/rsst/blob/main/cairn/items/0089-search-that-can-be-scoped-and-refined.md) Search that can be scoped and refined <sup>feature · v1.8 · p2</sup>
...
- [ ] [`0090`](https://github.com/oddurs/rsst/blob/main/cairn/items/0090-keep-what-you-have-seen-not-only-what-the-feed-still-lists.md) Keep what you have seen, not only what the feed still lists <sup>feature · v1.9 · p1</sup>
- [ ] [`0091`](https://github.com/oddurs/rsst/blob/main/cairn/items/0091-a-retention-policy-now-that-history-is-kept.md) A retention policy, now that history is kept <sup>feature · v1.9 · p2</sup>
- [ ] [`0092`](https://github.com/oddurs/rsst/blob/main/cairn/items/0092-per-feed-settings-beyond-four-fields.md) Per-feed settings beyond four fields <sup>feature · v1.9 · p2</sup>
- [ ] [`0093`](https://github.com/oddurs/rsst/blob/main/cairn/items/0093-feeds-that-need-a-password.md) Feeds that need a password <sup>feature · v1.9 · p3</sup>
- [ ] [`0094`](https://github.com/oddurs/rsst/blob/main/cairn/items/0094-layout-and-density-options.md) Layout and density options <sup>feature · v1.9 · p3</sup>
- [ ] [`0095`](https://github.com/oddurs/rsst/blob/main/cairn/items/0095-a-view-of-how-each-feed-is-behaving.md) A view of how each feed is behaving <sup>feature · v1.9 · p3</sup>
...
- [ ] [`0096`](https://github.com/oddurs/rsst/blob/main/cairn/items/0096-sync-with-a-self-hosted-server.md) Sync with a self-hosted server <sup>feature · v2.0 · p1</sup>
