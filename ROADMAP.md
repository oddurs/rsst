...
- [ ] [`0077`](https://github.com/oddurs/rsst/blob/main/cairn/items/0077-unsubscribe-from-a-feed-without-editing-the-config.md) Unsubscribe from a feed without editing the config <sup>feature · v1.7 · p1</sup>
