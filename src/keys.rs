...
const ACTIONS: &[(Action, &str, &str, &str)] = &[
    ...
    (
        ...
        "cycle_sort",
        "Reading",
        "sort by published / received / title / feed",
    ),
    (
        Action::ToggleFeedSort,
        "toggle_feed_sort",
        "Reading",
        "give this feed its own order",
    ),
    (
    ...
    (
        ...
        "move_feed",
        "Feeds",
        "move this feed to a folder",
    ),
    (
        Action::Unsubscribe,
        "unsubscribe",
        "Feeds",
        "unsubscribe from this feed (asks)",
    ),
